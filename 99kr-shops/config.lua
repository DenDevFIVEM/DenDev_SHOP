Config = {
    ...
    Locations = {
        ...
        [21] = {
            ["shelfs"] = {
                {["x"] = -629.07, ["y"] = -275.92, ["z"] = 35.58, ["value"] = "checkout"},
                {["x"] = -632.79, ["y"] = -275.90, ["z"] = 35.58, ["value"] = "diverse"},
            },
            ["cashier"] = {
                ["x"] = -627.43, ["y"] = -274.88, ["z"] = 34.58, ["h"] = 120.96,
        ...
        [22] = {
            ["shelfs"] = {
                {["x"] = -627.26, ["y"] = -278.49, ["z"] = 35.58, ["value"] = "checkout"},
                {["x"] = -629.18, ["y"] = -282.12, ["z"] = 35.58, ["value"] = "diverse"},
            },
            ["cashier"] = {
                ["x"] = -625.92, ["y"] = -277.62, ["z"] = 34.58, ["h"] = 120.96,
                ["hash"] = "a_m_y_business_03"
            },
        },
    },
    ...
    Locales = {
        ["checkout"] = "Premi ~INPUT_PICKUP~ per accedere al registratore",
        ["drinks"] = "Premi ~INPUT_PICKUP~ per accedere al menu",
        ["snacks"] = "Premi ~INPUT_PICKUP~ per accedere al menu",
        ["readymeal"] = "Premi ~INPUT_PICKUP~ per accedere al menu",
        ["diverse"] = "Premi ~INPUT_PICKUP~ per accedere al menu",
    },

    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 14},
            {label = "Canada Dry", item = 'canadadry', price = 20},
        },
        ["snacks"] = {
            {label = "Resee's", item = "reeses", price = 12},
            {label = "AirHeads", item = "airheads", price = 20},
        },
        ["readymeal"] = {
            {label = "Kebab Pizza", item = "pizza", price = 30},
        },
        ["diverse"] = {
            {label = "Telefono", item = "phone", price = 2000},
            {label = "Sim", item = "sim", price = 20},
            {label = "Manette", item = "handcuffs", price = 30},
            {label = "Chiavi Manette", item = "key", price = 20},
            {label = "GPS", item = "gps", price = 40},
            {label = "Radio", item = "radio", price = 500},
        },
    },
}